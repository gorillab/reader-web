...
module.exports = {
  ...
  plugins: [
    ...
    new ExtractTextPlugin({
      filename: 'static/css/[name].[id].[contenthash:8].css',
      allChunks: true,
    }),
    ...
    new SWPrecacheWebpackPlugin({
      ...
      navigateFallbackWhitelist: [/^(?!\/(__|images|favicon|manifest|api|admin)).*/],
      staticFileGlobs: [
        paths.appBuild + '/images/*.*',
        paths.appBuild + '/favicon.*',
